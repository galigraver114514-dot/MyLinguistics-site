...
window.ML_I18N = (function () {
  ...
  var STRINGS = {
    en: {
      ...
      'wb.river.aria': 'The word river. Drag to cast the net.',
    ...
    zh: {
      ...
      'wb.river.aria': '词汇之河。拖动撒网打捞。',
      'wb.river.catch': '捞到 {n} 个词',
      'wb.river.keep': '收进单词池',
      'wb.river.release': '放生',
      'wb.river.kept': '已把 {total} 个词中的 {n} 个收进池子。',
      'wb.tab.inbox': '候选',
    ...
    ja: {
      ...
      'wb.river.aria': '単語の川。ドラッグして網を引きます。',
      'wb.river.catch': '{n} 語をすくいました',
      'wb.river.keep': 'プールに入れる',
      'wb.river.release': '逃がす',
      'wb.river.kept': '{total} 語のうち {n} 語をプールに入れました。',
      'wb.tab.inbox': '候補',
